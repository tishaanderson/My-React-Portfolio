    ...
    <div className='portfolio'>
      ...
      <div className='half-page'>
        <div className="card">
          ...
          <div class="card-body">
          <h5 class="card-title">SMU Bootcamp Project #1</h5>
          <ul class="list-group list-group-flush">
              <li class="list-group-item"><b>Week:</b> 8</li>
              <li class="list-group-item"><b>Coding Language:</b> HTML, CSS, JavaScript, Web, Third-Party, and Server-Side APIs </li>
              <li class="list-group-item"><b>Github: </b> 
        ...
        <div className="card">
          ...
          <h5 class="card-title">SMU Bootcamp Challenge</h5>
          <ul class="list-group list-group-flush">
              <li class="list-group-item"><b>Week 14:</b> MVC</li>
              <li class="list-group-item"><b>Coding Language:</b> SQL, ORM, Express, MVC </li>
              <li class="list-group-item"><b>Github: </b> 
